...
<YYINITIAL>
{
	...
	{id} {return symbol(sym.ID,new Integer(yytext()));}
	{type} {return symbol(sym.TYPE,new Integer(yytext()));}
	{arduino_model} {return symbol(sym.ARDUINO_MODEL,new Integer(yytext()));}
